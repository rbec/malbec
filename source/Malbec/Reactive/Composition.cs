...
namespace Malbec.Reactive
{
  public static class Composition
  {
    ...
    public static IExp<Δ0, T> ℱ<TX, T>(Func<TX, T> f, IExp<Δ0, TX> x)
      => new FunctionExp<Δ0, Δ0, TX, T, T>(new Function<TX, T>(f), x);

    public static IExp<Δ0, T> ℱ<TX, TY, T>(Func<TX, TY, T> f, IExp<Δ0, TX> x, IExp<Δ0, TY> y)
    ...
    public static IExp<Δ0, T?> Option<T>(IExp<Δ0, bool> x, IExp<Δ0, T> y) where T : struct
      => Invoke(Choose(new ConstantExp<Δ0, T?>(null), ℱ(AsNullable, y), x));
